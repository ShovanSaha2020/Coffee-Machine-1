...
water_in_storage = int(input("Write how many ml of water the coffee machine has:\n"))
milk_in_storage = int(input("Write how many ml of milk the coffee machine has:\n"))
